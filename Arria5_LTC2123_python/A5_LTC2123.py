...
try:
    ...
    #                                      
    string = dc590.transfer_packets('G M0 xS03SE5X xS04S0CX xS06S1FX xS07S01X xS08S11X xS0AS03X', 0)
    #Dump ALL registers
    ...
    transaction_write(dc590, (JESD204B_BASE + 0x54), 4, [0x02, 0x08, 0x10, 0x02]) # ENABLE rbd_offset, ANY sysref edge resets LMFC
