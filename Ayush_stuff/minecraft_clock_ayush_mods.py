...
#    drawHourHand(mc, clockCentre, time.hour, time.minute, block.DIRT)
    drawHourHand(mc, clockCentre, time.hour, time.minute, block.GRAVEL)
    #draw minute hand

#    drawMinuteHand(mc, clockCentre, time.minute, block.STONE)
    drawMinuteHand(mc, clockCentre, time.minute, block.BED)
    #draw second hand
#    drawSecondHand(mc, clockCentre, time.second, block.WOOD_PLANKS)
    drawSecondHand(mc, clockCentre, time.second, block.CHEST)
...
#    clockCentre = minecraft.Vec3(116, 42, 153)
    radius = 20
    time.sleep(5)
    #Connect to minecraft by creating the minecraft object
    # - minecraft needs to be running and in a game
    mc = minecraft.Minecraft.create("10.26.148.195")
