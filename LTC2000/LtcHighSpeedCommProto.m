...
% int LthsSpiSetMode(LthsHandle handle, int mode); 
functions.name{iFunction} = 'LthsSpiSetMode';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'int32'};
iFunction = iFunction+1;

% int LthsSpiSendByte(LthsHandle handle, uint8_t value); 
functions.name{iFunction} = 'LthsSpiSendByte';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
...
% int LthsSpiReceiveByte(LthsHandle handle, uint8_t * value); 
functions.name{iFunction} = 'LthsSpiReceiveByte';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
...
% int LthsSpiTransceiveByte(LthsHandle handle, uint8_t send_value,
%     uint8_t * receive_value); 
functions.name{iFunction} = 'LthsSpiTransceiveByte';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
...
%     int num_address_bytes, uint8_t value); 
functions.name{iFunction} = 'LthsSpiSendByteAtAddress';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint32', 'int32', 'uint8'};
iFunction = iFunction+1;

% int LthsSpiSendBytesAtAddress(LthsHandle handle, uint32_t address,
%     int num_address_bytes, uint8_t * values, int num_values); 
functions.name{iFunction} = 'LthsSpiSendBytesAtAddress';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint32', 'int32', ...
    'uint8Ptr', 'int32'};
iFunction = iFunction+1;
...
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint32', 'int32', 'uint8Ptr'};
iFunction = iFunction+1;
...
% int LthsFpgaSetReset(LthsHandle handle, int pin_state); 
functions.name{iFunction} = 'LthsFpgaSetReset';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'int32'};
iFunction = iFunction+1;
...
% int LthsFpgaI2cSetBitBangRegister(LthsHandle, uint8_t register_address); 
functions.name{iFunction} = 'LthsFpgaI2cSetBitBangRegister';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint8'};
iFunction = iFunction+1;

% int LthsFpgaI2cSendByte(LthsHandle handle, uint8_t address,
%     uint8_t value); 
functions.name{iFunction} = 'LthsFpgaI2cSendByte';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint8', 'uint8'};
iFunction = iFunction+1;

% int LthsFpgaI2cSendBytes(LthsHandle handle, uint8_t address,
%  uint8_t * values, int num_values); 
functions.name{iFunction} = 'LthsFpgaI2cSendBytes';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint8', 'uint8Ptr', 'int32'};
iFunction = iFunction+1;

% int LthsFpgaI2cReceiveByte(LthsHandle handle, uint8_t address,
%     uint8_t * value); 
functions.name{iFunction} = 'LthsFpgaI2cReceiveByte';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint8', 'uint8Ptr'};
iFunction = iFunction+1;

% int LthsFpgaI2cReceiveBytes(LthsHandle handle, uint8_t address,
%     uint8_t * values, int num_values); 
functions.name{iFunction} = 'LthsFpgaI2cReceiveBytes';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint8', 'uint8Ptr', 'int32'};
iFunction = iFunction+1;

% int LthsFpgaI2cReceiveString(LthsHandle handle, uint8_t address,
%     char * buffer, int buffer_size); 
functions.name{iFunction} = 'LthsFpgaI2cReceiveString';
functions.calltype{iFunction} = 'cdecl';
functions.LHS{iFunction} = 'int32';
functions.RHS{iFunction} = {'voidPtr', 'uint8', 'cstring', 'int32'};
