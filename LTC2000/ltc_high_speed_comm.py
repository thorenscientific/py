...
class Lths(object):
    ...
    def fifo_send_bytes(self, values, start=0, end=-1):
        ...
        """
        return self._fifo_send_by_type("ubyte", values, start, end)
    ...
    def fifo_send_uint16_values(self, values, start=0, end=-1):
        ...
        the same as for slices.
        """
        return self._fifo_send_by_type("uint16", values, start, end)
    ...
    def fifo_send_uint32_values(self, values, start=0, end=-1):
        ...
        the same as for slices.
        """
        return self._fifo_send_by_type("uint32", values, start, end)
    ...
    def spi_send_bytes(self, values, start=0, end=-1):
        """Send elements of values[start:end] via SPI.
