...
class AGILENT_34401A(SCPI_Instrument):
    """Agilent 34401A DVM Driver"""
    
    def __init__(self,model="34401A",address="GPIB0::22",debug=False):
        """Agilent 34401A Constructor."""
        SCPI_Instrument.__init__(self,model,address,debug=debug)
    ...
    def configure_dc_voltage(self,dvm_range=None,dvm_resolution=None,nplc=None):
        ...
        self.__execute_command("CONF:","VOLT:DC",dvm_range,dvm_resolution,None,False)
        if nplc!=None:
