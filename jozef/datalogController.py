...
from instrumentControllerConcise import *
import operator
import itertools
...
inpA=Multimeter_34401a(25) #current meter
inmA=Multimeter_34401a(26)
inpA.reset()
inpA.setupi()
inmA.reset()
inmA.setupi()

#outp_mm=Multimeter_3478a(23) 
#outm_mm=Multimeter_3478a(24) 
outp_mm=Multimeter_34401a(23)
outm_mm=Multimeter_34401a(24)
outp_mm.reset()
outm_mm.reset()
...
class dlog:
        ...
        def Print2(self,result,line='DLOG A MA 5.2 "PADJ @5V +/-IN=VCM=1.25V POST TRIM"'):
                result=float(result)  #rl2 returns string
...
def test60():
    power('OFF')
    raw_input("Test 60: joker connects to cm")   
