...
#    L_SQUIR_IMG = pygame.image.load('squirrel.png')
    L_SQUIR_IMG = pygame.image.load('batman.png')
...
def runGame():
  ...
  #  invulnerableMode = False  # if the player is invulnerable
    invulnerableMode = True  # if the player is invulnerable
    ...
    winSurf = BASICFONT.render('You have achieved OMEGA BATMAN!', True, WHITE)
